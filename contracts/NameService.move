module umi_name_service::name_service {
    ...
    const ENAME_TOO_SHORT: u64 = 6;
    const ENAME_TOO_LONG: u64 = 7;
    ...
    public entry fun register_domain(
        ...
        let price = calculate_price(&name);
    ...
    // Helper function to calculate price based on name length
    fun calculate_price(name: &String): u64 {
